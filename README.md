...
### Versions of the software(Updated: November 8th 2014):

  * Nginx 1.7.7

  * MariaDB 10.0.14

  * PHP 5.6.2 (Non Thread Safe + FastCGI)
...
### How to Install
  ...
  1. To install download the latest version of Wnmp [here][1] (latest version 2.1.4)
