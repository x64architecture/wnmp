...
### Versions of the software(Updated: September 10th 2013): ######

  * Nginx 1.5.4

  * MariaDB 5.5.32

  * PHP 5.4.19 (Non Thread Safe + FastCGI)

  * phpMyAdmin 4.0.6
### How to Install ######

  1. To install download the latest version of Wnmp [here][1] (latest version 2.0.2.8)
...
[1]: https://bitbucket.org/x64architecture/windows-nginx-mysql-php/downloads/Wnmp%202.0.2.8.exe
