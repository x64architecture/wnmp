...
### Versions of the software(Updated: August 7th 2013): ######
...
### How to Install ######
  ...
  1. To install download the latest version of Wnmp [here][1] (latest version 2.0.2.6)
...
[1]: https://bitbucket.org/x64architecture/windows-nginx-mysql-php/downloads/Wnmp%202.0.2.6.exe
